  ...
  return (
    <section className="px-4 py-12 md:px-6 md:py-16">
      <div className="mx-auto max-w-[1100px]">
        <p className="font-mono text-[11px] tracking-widest text-muted uppercase">Archive</p>
          ...
          {projects.map((project) => (
            <li key={project.slug}>
              <Link
                ...
                className={`group block overflow-hidden rounded-[28px] border border-line p-4 transition-transform hover:scale-[1.015] ${accentBg[project.accent] ?? 'bg-paper'}`}
              >
